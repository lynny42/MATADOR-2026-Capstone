...
GS_PACKET_TYPE_SNAPSHOT = "SAT_SNAPSHOT"
GS_PACKET_TYPE_BULK = "SAT_BULK_TELEMETRY"
# 통합 스냅샷 — SAT_SNAPSHOT.SNAPSHOT_ID 로 PWR/TLM/ADCS history 상관
SNAPSHOT_ID_COL = "SNAPSHOT_ID"
SNAPSHOT_AT_COL = "SNAPSHOT_AT"
...
# ============================================================
# 전력 초기 임계치 (SW_ID 0~3) — 아두이노 INA226 실측 (2026-06-04)
#   SW_0 MPU:   대기·자이로 ON 3.37~3.43V — HI 3.38 은 평상 오탐 → 3.58 로 상향
#   SW_1 OBC(RPi): 대기 ~4.89V — 밴드 넓게(오탐 억제)
#   SW_2 Servo: 대기 ~4.75V, 부하 ~4.67V (idle detach 후 미세진동)
#   SW_3:       조도 전용 — 시드용
# init_db 시 SAT_PWR_META.V_THRESHOLD_* 동기화 (_sync_sat_pwr_meta_thresholds)
# ============================================================
V_THRESHOLD_LO = [3.08, 4.05, 3.85, 3.0]
V_THRESHOLD_HI = [3.58, 5.20, 5.10, 3.6]
...
# ADCS 한 사이클 수신 후 DB flush + 통합 SNAPSHOT (TLM_DB_FLUSH_TRIGGER_MID = DO)
